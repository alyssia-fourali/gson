...
public class ProtosWithPrimitiveTypesTest {
  ...
  public void testDeserializeEmptyProto() {
    SimpleProto proto = gson.fromJson.fromJson("{}", SimpleProto.class);
  ...
  public void testDeserializeProto() {
    SimpleProto proto = gson.fromJson.fromJson("{msg:'foo',count:3}", SimpleProto.class);
  ...
  public void testDeserializeWithExplicitNullValue() {
    SimpleProto proto = gson.fromJson.fromJson("{msg:'foo',count:null}", SimpleProto.class);
    assertEquals("foo", proto.getMsg());
