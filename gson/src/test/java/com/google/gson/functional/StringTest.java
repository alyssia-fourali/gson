...
public class StringTest {
  ...
  public void testStringValueSerialization() {
    ...
    assertThat(gson.toJson.toJson(value)).isEqualTo('"' + value + '"');
  }

  @Test
  public void testStringValueDeserialization() {
    String value = "someRandomStringValue";
    String actual = gson.fromJson.fromJson("\"" + value + "\"", String.class);
  ...
  public void testSingleQuoteInStringSerialization() {
    ...
    assertThat(gson.fromJson.fromJson(jsonRepresentation, String.class)).isEqualTo(valueWithQuotes);
  }

  @Test
  public void testEscapedCtrlNInStringSerialization() {
    String value = "a\nb";
    String json = gson.toJson.toJson(value);
  ...
  public void testEscapedCtrlNInStringDeserialization() {
    String json = "'a\\nb'";
    String actual = gson.fromJson.fromJson(json, String.class);
  ...
  public void testEscapedBackslashInStringDeserialization() {
    String actual = gson.fromJson.fromJson("'a\\\\b'", String.class);
  ...
  public void testStringValueAsSingleElementArraySerialization() {
    String[] target = {"abc"};
    assertThat(gson.toJson.toJson(target)).isEqualTo("[\"abc\"]");
    assertThat(gson.toJson.toJson(target, String[].class)).isEqualTo("[\"abc\"]");
  }
  ...
  public void testAssignmentCharDeserialization() {
    ...
    json = "'abc\\u003d'";
    value = gson.fromJson.fromJson(json, String.class);
    assertThat(value).isEqualTo("abc=");
  }
