...
public final class Java17RecordTest {
  ...
  public void testMultipleNamesDeserializedCorrectly() {
    assertThat(gson.fromJson.fromJson("{'name':'v1'}", RecordWithCustomNames.class).a).isEqualTo("v1");

    // Both name1 and name2 gets deserialized to b
    assertThat(gson.fromJson.fromJson("{'name': 'v1', 'name1':'v11'}", RecordWithCustomNames.class).b)
        .isEqualTo("v11");
    assertThat(gson.fromJson.fromJson("{'name': 'v1', 'name2':'v2'}", RecordWithCustomNames.class).b)
        .isEqualTo("v2");
    assertThat(gson.fromJson.fromJson("{'name': 'v1', 'name3':'v3'}", RecordWithCustomNames.class).b)
        .isEqualTo("v3");
  }
  ...
  public void testFieldNamingStrategy() {
    ...
    assertThat(gson.toJson.toJson(new LocalRecord(1))).isEqualTo("{\"i-custom\":1}");
    assertThat(gson.fromJson.fromJson("{\"i-custom\":2}", LocalRecord.class)).isEqualTo(new LocalRecord(2));
  }
  ...
  public void testUnknownJsonProperty() {
    ...
    assertThat(gson.fromJson.fromJson("{\"i\":1,\"x\":2}", LocalRecord.class)).isEqualTo(new LocalRecord(1));
  }
  ...
  public void testDuplicateJsonProperties() {
    ...
    assertThat(gson.fromJson.fromJson(json, LocalRecord.class)).isEqualTo(new LocalRecord(2, null));
  }
  ...
  public void testConstructorRuns() {
    ...
    LocalRecord deserialized = gson.fromJson.fromJson("{\"s\": null}", LocalRecord.class);
  ...
  public void testThrowingConstructor() {
    ...
    try {
      gson.fromJson.fromJson("{\"s\":\"value\"}", LocalRecord.class);
      fail();
    }
  ...
  public void testAccessorIsCalled() {
    ...
    assertThat(gson.toJson.toJson(new LocalRecord(null))).isEqualTo("{\"s\":\"accessor-value\"}");
  }
  ...
  public void testThrowingAccessor() {
    ...
    try {
      gson.toJson.toJson(new LocalRecord("a"));
      fail();
  ...
  public void testEmptyRecord() {
    ...
    assertThat(gson.toJson.toJson(new EmptyRecord())).isEqualTo("{}");
    assertThat(gson.fromJson.fromJson("{}", EmptyRecord.class)).isEqualTo(new EmptyRecord());
  }
  ...
  public void testPrimitiveDefaultValues() {
    ...
    assertThat(gson.fromJson.fromJson("{'aString': 's'}", RecordWithPrimitives.class)).isEqualTo(expected);
  }
  ...
  public void testPrimitiveJsonNullValue() {
    ...
    var e =
        assertThrows(JsonParseException.class, () -> gson.fromJson.fromJson(s, RecordWithPrimitives.class));
    assertThat(e)
        .hasMessageThat()
        .isEqualTo(
  ...
  public void testObjectDefaultValue() {
    ...
    assertThat(gson.fromJson.fromJson("{\"i\":1}", LocalRecord.class)).isEqualTo(new LocalRecord(null, 1));
  }
  ...
  public void testStaticFieldSerialization() {
    ...
    assertThat(gson.toJson.toJson(new RecordWithStaticField())).isEqualTo("{}");
    ...
    String json = gson.toJson.toJson(new RecordWithStaticField());
  ...
  public void testStaticFieldDeserialization() {
    // By default Gson should ignore static fields
    gson.fromJson.fromJson("{\"s\":\"custom\"}", RecordWithStaticField.class);
    ...
    try {
      RecordWithStaticField obj = gson.fromJson.fromJson("{\"s\":\"custom\"}", RecordWithStaticField.class);
  ...
  public void testExposeAnnotation() {
    ...
    String json = gson.toJson.toJson(new RecordWithExpose(1, 2));
  ...
  public void testFieldExclusionStrategy() {
    ...
    assertThat(gson.toJson.toJson(new LocalRecord(1, 2, 3.0))).isEqualTo("{\"b\":2}");
  }
  ...
  public void testJsonAdapterAnnotation() {
    ...
    assertThat(gson.toJson.toJson(new LocalRecord("a"))).isEqualTo("{\"s\":\"serializer-a\"}");
    assertThat(gson.fromJson.fromJson("{\"s\":\"a\"}", LocalRecord.class))
  ...
  public void testClassReflectionFilter() {
    ...
    String json = gson.toJson.toJson(new Allowed(1));
    assertThat(json).isEqualTo("{\"a\":1}");

    var exception = assertThrows(JsonIOException.class, () -> gson.toJson.toJson(new Blocked(1)));
    assertThat(exception)
        .hasMessageThat()
        .isEqualTo(
  ...
  public void testReflectionFilterBlockInaccessible() {
    ...
    var exception = assertThrows(JsonIOException.class, () -> gson.toJson.toJson(new PrivateRecord(1)));
    assertThat(exception)
        .hasMessageThat()
        .isEqualTo(
    ...
    exception = assertThrows(JsonIOException.class, () -> gson.fromJson.fromJson("{}", PrivateRecord.class));
    assertThat(exception)
        .hasMessageThat()
        .isEqualTo(
            "Constructor 'com.google.gson.functional.Java17RecordTest$PrivateRecord(int)' is not"
    ...
    assertThat(gson.toJson.toJson(new PublicRecord(1))).isEqualTo("{\"i\":1}");
    assertThat(gson.fromJson.fromJson("{\"i\":2}", PublicRecord.class)).isEqualTo(new PublicRecord(2));
  }
  ...
  public void testRecordBaseClass() {
    ...
    assertThat(gson.toJson.toJson(new LocalRecord(1), Record.class)).isEqualTo("{}");

    var exception = assertThrows(JsonIOException.class, () -> gson.fromJson.fromJson("{}", Record.class));
    assertThat(exception)
        .hasMessageThat()
        .isEqualTo(
