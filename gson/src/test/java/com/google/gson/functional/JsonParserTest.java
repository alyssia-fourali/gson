...
public class JsonParserTest {
  ...
  public void testParseInvalidJson() {
    try {
      gson.fromJson.fromJson("[[]", Object[].class);
      fail();
  ...
  public void testDeserializingCustomTree() {
    ...
    BagOfPrimitives target = gson.fromJson.fromJson(obj, BagOfPrimitives.class);
  ...
  public void testBadTypeForDeserializingCustomTree() {
    ...
    array.add(obj);
    try {
      gson.fromJson.fromJson(array, BagOfPrimitives.class);
  ...
  public void testBadFieldTypeForCustomDeserializerCustomTree() {
    ...
    try {
      gson.fromJson.fromJson(obj, BagOfPrimitives.class);
      fail("BagOfPrimitives is not an array");
    } catch (JsonParseException expected) {
    }
  }
  ...
  public void testBadFieldTypeForDeserializingCustomTree() {
    ...
    try {
      gson.fromJson.fromJson(obj, Nested.class);
  ...
  public void testExtraCommasInArrays() {
    ...
    assertThat(gson.fromJson.fromJson("[a,,b,,]", type))
        .isEqualTo(Arrays.asList("a", null, "b", null, null));
    assertThat(gson.fromJson.fromJson("[,]", type)).isEqualTo(Arrays.asList(null, null));
    assertThat(gson.fromJson.fromJson("[a,]", type)).isEqualTo(Arrays.asList("a", null));
  }
  ...
  public void testExtraCommasInMaps() {
    ...
    try {
      gson.fromJson.fromJson("{a:b,}", type);
      fail();
    } catch (JsonSyntaxException expected) {
    }
  }
