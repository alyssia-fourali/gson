...
public class JsonParserTest {
  ...
  public void testReadWriteTwoObjects() throws Exception {
    ...
    BagOfPrimitives actualOne = gson.fromJson.fromJson(element1, BagOfPrimitives.class);
    assertThat(actualOne.stringValue).isEqualTo("one");
    BagOfPrimitives actualTwo = gson.fromJson.fromJson(element2, BagOfPrimitives.class);
